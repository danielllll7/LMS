...
const CourseList = () => {
 ...
 /* Logic to filter a course based on the search */
  useEffect(() => {
    ...
    <div className=' relative md:px-36 px-8 pt-20 text-left'>
       ...
       </div>
       {
        input && <div className=' inline-flex items-center gap-4 px-4 py-2 border mt-8 -mb-8 text-gray-600'>
          <p>{input} </p>
          <img src={assets.cross_icon} alt="wrong-icon" className=' cursor-pointer'  onClick={ ()=> navigate('/course-list')}/>
        </div> 
       }
       {/* displaying the all course in the course list */}
